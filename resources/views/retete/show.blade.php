                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <form class="row form-horizontal poststars" action="{{route('postStar', $reteta->id)}}"
                                ...
                                <div class="form-group required">
                                    <div class="col-sm-12">
                                        ...
                                        <input class="star star-5" value="4" id="star-4" type="radio" name="star" />
                                        <label class="star star-5" for="star-4"></label>
                                        <input class="star star-5" value="3" id="star-3" type="radio" name="star" />
                                        <label class="star star-5" for="star-3"></label>
                                        <input class="star star-5" value="2" id="star-2" type="radio" name="star" />
                            ...
                            <div class="row">
                                ...
                                <input id="rating-hidden" hidden value={{hasRated(Auth::id(),$reteta->id)->rating}}>
                                <form class="row form-horizontal poststars ml-2"
                                    action="{{route('deleteStar', $reteta->id)}}" id="addStar" method="POST">
                                    {{ csrf_field() }}
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide secondary-imgs"
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100"
                                            src="/uploads/retete/{{$reteta->utilizator_id}}/{{$reteta->id}}/{{$imagine}}"
